...
const LandingPage = () => {
  ...
  return (
    <div className="relative">
      ...
      <div>
        <h1 style={{ marginTop: "-450px", fontFamily: "poppins", fontSize: "55px", fontWeight: "500", marginLeft: "20px" }}>
          Best seller Coffees
        </h1>
      </div>
      ...
      >
        {bestsellerCoffees.map((coffee) => (
          <ProductCard key={coffee._id} product={coffee} source="landing" />
        ))}
      </div>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: "50px", flexWrap: "wrap", marginTop: "30px" }}>
        <div style={{ backgroundColor: "#FFF9EF", borderRadius: "10px", padding: "20px", width: "400px", textAlign: "center", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          <p style={{ fontSize: "18px", color: "#000000", marginBottom: "15px", lineHeight: "1.6", minHeight: "120px", fontFamily: "poppins" }}>
        ...
        <div style={{ backgroundColor: "#FFF9EF", borderRadius: "10px", padding: "20px", width: "400px", textAlign: "center", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          <p style={{ fontSize: "18px", marginBottom: "15px", lineHeight: "1.6", minHeight: "120px", fontFamily: "poppins" }}>
        ...
        <div style={{ backgroundColor: "#FFF9EF", borderRadius: "10px", padding: "20px", width: "400px", textAlign: "center", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          <p style={{ fontSize: "19px", marginBottom: "15px", lineHeight: "1.6", minHeight: "120px", fontFamily: "poppins" }}>
